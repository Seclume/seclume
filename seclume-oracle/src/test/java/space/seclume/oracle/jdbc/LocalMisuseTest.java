...
/**
 * JDBC called in the wrong order, against a real Oracle.
 *
...
class LocalMisuseTest {
    ...
    void everyCallOutOfOrderIsRefusedTheWayJdbcRefuses() {
        MisuseContract.check("oracle", LocalMisuseTest::connect, "select 1 from dual",
                MisuseContract.standard("select 1 from dual",
