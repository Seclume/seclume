...
class ReceiveBufferWipeTest {
    ...
    private static String bufferOf(PgChannel channel) throws Exception {
        ...
        // it gained a bounds check when the fuzz sweep found SQL Server
        // walking past a buffer through it. A test that inspects memory should
        // say so and reach for the segment; a decoder should not be able to.
